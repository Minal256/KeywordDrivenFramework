...
public class AmazonTestCases {
	...
	public void verifyIconNavbarItems() {
		Keywords.clickOnElement("CSS", "#hmenu-content>ul.hmenu.hmenu-visible>li>a");
		String[] expectedSubNavItems= {"Echo & Alex","Fire TV stick","Kindle E-Readers & eBooks","Amazon Prime Video","Amazon Prime Music",
										"Mobiles, Computers","TV, Appliances, Electronics",	"Men's Fashion","Women's Fashion","Home, Kitchen, pets",
										"Beauty, Health, Grocery","Sports, Fitness, Bags, Luggage","Toys, Baby products, Kids' Fashion","Car, Motorbike,Industrial",
										"Books & Audible","Movies, Music & Video Games","Gift Cards & Mobile Recharges","Global Store","Flight Tickets",
										"Full Store Directory","HELP & SETTINGS","Your Account","Customer Service","Sign In"};

		boolean isequal=Keywords.iconNavBarItems("CSS", "#hmenu-content>ul.hmenu.hmenu-visible>li>a").containsAll(Arrays.asList(expectedSubNavItems));
